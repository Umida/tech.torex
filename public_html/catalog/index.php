...
$APPLICATION->SetPageProperty('description',  'Купите металлические двери Torex с доставкой и установкой от 21 208 руб. У нас вы найдете полный каталог с ценами на входные двери Торэкс в Москве, Санкт-Петербурге, Калуге, Архангельске и Калининграде для квартиры и дома.');
?>
<?
    

$GLOBALS['arrFilter']['OFFERS']['PROPERTY']['CITY']= $userCity["cityXML"];
$APPLICATION->IncludeComponent("bitrix:catalog", "main", array(
	...
	"SEF_URL_TEMPLATES" => array(
		"sections" => "",
		"section" => "vhodnye-dveri/#SECTION_CODE#/",
		"element" => "product/#ELEMENT_CODE#/",
		"offer" => "product/#ELEMENT_CODE#/#OFFER_CODE#/",
		"redirect" => "vhodnye-dveri/#SECTION_CODE#/#ELEMENT_CODE#/",
		"compare" => "compare/",
	)
	),
	false
