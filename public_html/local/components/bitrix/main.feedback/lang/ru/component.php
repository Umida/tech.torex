<?
$MESS ['MF_OK_MESSAGE'] = "Ваше сообщение принято.";
$MESS ['MF_REQ_PHONE'] = "Укажите верно ваш телефон.";
$MESS ['MF_REQ_NAME'] = "Укажите ваше имя.";
$MESS ['MF_REQ_EMAIL'] = "Укажите верно E-mail, на который хотите получить ответ.";
