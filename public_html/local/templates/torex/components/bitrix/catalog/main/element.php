...
<div class="crisper">
		...
		$elementId = $APPLICATION->IncludeComponent('bitrix:catalog.element', 'main', $componentElementParams,
			$component
		);
...
<?	if (!isset($arParams['DETAIL_SHOW_POPULAR']) || $arParams['DETAIL_SHOW_POPULAR'] != 'N')
		...
		if (
				...
				{
					?>
						<div class="viewed-carausel" data-entity="parent-container">
							<div class="catalog-block-header" data-entity="header" data-showed="false" style="display: none; opacity: 0;">
								<?=GetMessage('CATALOG_VIEWED')?>
							</div>
							<? 
							
							$APPLICATION->IncludeComponent('bitrix:catalog.products.viewed', 'element', array(
									'IBLOCK_MODE' => 'single',
									'IBLOCK_TYPE' => $arParams['IBLOCK_TYPE'],
									'IBLOCK_ID' => $arParams['IBLOCK_ID'],
