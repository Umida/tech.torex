...
if (isset($arResult['ITEM']))
{
	...
	$item = $arResult['ITEM'];
	$rsFile = CFile::GetByID($arResult['ITEM']["PROPERTIES"]["MAIN_PHOTO_R"]["VALUE"]);
	$arFile = $rsFile->Fetch();
		...
		if (!$haveOffers)
		{
			$jsParams = array(
				...
				'PRODUCT' => array(
					...
					'PICT' => CFile::GetPath($item["PROPERTIES"]["MAIN_PHOTO_R"]["VALUE"]),
				...
				'VISUAL' => array(
					'ID' => $itemIds['ID'],
					'PICT_ID' => $item["PROPERTIES"]["MAIN_PHOTO_R"]["VALUE"],
