...
<div class="prods-line_item-container">
  <div class="prods-line_item-image">
      	<a style="display:none" class="product-item-image-wrapper" href="<?=$product_url?>" title="<?=$imgTitle?>"
		...
		<span class="product-item-image-original" id="<?=$itemIds['PICT']?>"
			style="background-image: url('<?=CFile::GetPath($item["PROPERTIES"]["MAIN_PHOTO_R"]["VALUE"])?>'); <?=($showSlider ? 'display: none;' : '')?>">
		</span>
	</a>
                <a href="<?=$product_url?>">
                	...
                	<?if ($actualItem['CAN_BUY'])
					{
						?>
							...
							<div class="product-item-button-container" id="<?=$itemIds['BASKET_ACTIONS']?>">
									<a class="catalog-section-item-buy-btn" id="<?=$itemIds['BUY_LINK']?>"
										href="javascript:void(0)" rel="nofollow" id="<?=$itemIds['PREBUY_OPEN_BTN']?>"><i data-svg="cart"></i>
						</a>
								</div>
						<?php
					}?>
