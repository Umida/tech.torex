...
<div class="prods-line_item-container">
  <div class="prods-line_item-image">
            ...
            <div class="prods-line_item-desc">
                ...
                <div class="item-desc_title">
                    <a href="<?=$product_url?>"><?=$item["NAME"]?></a>
                </div>
            ...
            <div class="prods-line_item-btn">
                	<div class="prods-line_item-price" id="<?=$itemIds['PRICE']; ?>">
										<?php
										$priceclass='';
										...
										if (!empty($price))
										{
											...
											{
												echo '<span class="price'.$priceclass.'">'.$price['PRINT_RATIO_PRICE'].'</span>';
											}
											if (!empty($actualItem["PROPERTIES"]["OLD_PRICE"]["VALUE"])){
										        echo '<span class="old_price">'.CurrencyFormat($actualItem["PROPERTIES"]["OLD_PRICE"]["VALUE"], 'RUB').'</span>';
										    }
										}
										?>
									</div>
					<div class="catalog-section-btns-block">
                	<?if ($actualItem['CAN_BUY'])
					{
						?>
						
						<button data-productID="<?=$actualItem['ID'];?>" class="add-to-cart catalog-section-item-buy-btn" id="<?=$itemIds['BUY_LINK']?>"><i data-svg="cart"></i>
						</button>
					...
					<button class="catalog-section-item-fav-btn" id="<?=$itemIds['PREBUY_OPEN_BTN']?>"><i data-svg="fav"></i>
					</button>
					<button class="catalog-section-item-comp-btn" id="<?=$itemIds['PREBUY_OPEN_BTN']?>"><i data-svg="comp"></i>
					</button>
					</div>
            </div>
        </div>
