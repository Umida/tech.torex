...
?>
<div class="smart-filter" data-count="<?=$arResult['CHECKED_COUNT']?>">
    <div class="smart-filter-section">
        <div class="header">
            <button data-filter-togggle><i data-svg="times"></i></button>
        </div>
        ...
        <form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter">
            ...
            foreach($arResult["ITEMS"] as $key=>$arItem)//prices
            {
                foreach($arItem["VALUES"] as $val => $ar){
                	if($ar["CHECKED"]){
        	        //	$flt_values[$arItem["CODE"]]=($flt_values[$arItem["CODE"]]?$flt_values[$arItem["CODE"]].', ':'').$ar["VALUE"];
                ...
                if(isset($arItem["PRICE"])):
                    ...
                    <div class="item mb-2 smart-filter-parameters-box bx-active">
                        <span class="smart-filter-container-modef"></span>

                        <div class="smart-filter-parameters-box-title" onclick="smartFilter.hideFilterProps(this)">
                            <span class="smart-filter-parameters-box-title-text">Цена</span>
                            <span data-role="prop_angle" class="smart-filter-angle smart-filter-angle-up">
									<i data-svg="arrow-simple-dark"></i>
								</span>
                        </div>

                        <div class="smart-filter-block" data-role="bx_filter_block">
                            <div class="filters smart-filter-parameters-box-container">
                                <div class="smart-filter-input-group-number">
                                    <div class="d-flex justify-content-between">
                                        <div class="form-group-number" style="width: calc(50% - 10px);">
                                            <div class="smart-filter-input-container">
                                                <div class="d-flex flex-as">
                                                <span class="filter-title"><?=GetMessage("CT_BCSF_FILTER_FROM")?></span>
                                                <input
                                                        class="min-price"
                                                        type="text"
                                        ...
                                        <div class="form-group-number" style="width: calc(50% - 10px);">
                                            <div class="smart-filter-input-container">
                                               <div class="d-flex flex-as">
                                                <span class="filter-title"><?=GetMessage("CT_BCSF_FILTER_TO")?></span>
                                                <input
                                                        class="max-price"
                                                        type="text"
            ...
            foreach($arResult["ITEMS"] as $key=>$arItem)
            {
                ...
                <div class="item smart-filter-parameters-box <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>bx-active<?endif?>" data-id="<?=$arItem['ID'];?>">
                    <span class="smart-filter-container-modef"></span>
                    <div class="smart-filter-parameters-box-title" onclick="smartFilter.hideFilterProps(this)">
                    ...
                    <div class="smart-filter-block" data-role="bx_filter_block">
                        <div class="filters smart-filter-parameters-box-container">
                            ...
                            ?>
                                ...
                                <?foreach($arItem["VALUES"] as $val => $ar):?>
                                <div class="filter radio" <? echo $ar["CHECKED"]? 'checked="checked"': '' ?>>
                            ...
                            ?>
                                <div class="smart-filter-input-group-checkbox-list">
                                    <?foreach($arItem["VALUES"] as $val => $ar):?>
                                        <div class="filter check form-group form-check mb-1" <? echo $ar["CHECKED"]? 'checked="checked"': '' ?>>
                                            <input
                                                    type="checkbox"
                ...
                <div class="smart-filter-button-box">
                    <div class="smart-filter-block">
                        <div class="smart-filter-parameters-box-container">
                            ...
                            />
                            <input
                                    class="btn btn-link justify"
                                    type="submit"
                                    id="del_filter"
                                    name="del_filter"
                                    value="<?=GetMessage("CT_BCSF_DEL_FILTER")?>"
                            />
                            <div class="smart-filter-popup-result right" id="modef" <?if(!isset($arResult["ELEMENT_COUNT"])) echo 'style="display:none"';?>>
